...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
            function test(){
                if(tinyMCEPopup.editor.container.document != undefined){
                    document.getElementById("imgList").innerHTML = tinyMCEPopup.editor.container.document.getElementById("imagelist").innerHTML;
                }else{
                    document.getElementById("imgList").innerHTML = tinyMCEPopup.editor.container.ownerDocument.getElementById("imagelist").innerHTML;

                }
                document.getElementById("imgList").style.height = 180;
            }
    ...
    <body id="advimage" style="display: none" onload="test()">
        <f:view>
            <h:form enctype="multipart/form-data" id="image" onsubmit="ImageDialog.insert();return false;">
                ...
                <div id="general_panel" class="panel current">
                    <fieldset>
                        ...
                        <table class="properties">
                            <tr>
                               <td>
                                    <t:inputFileUpload value="#{ArticleUpdate_Backing.upImg}" size="20" />
                                    <t:inputText id="imgId" value="#{ImageUpload_Backing.id}"/>
                                    <h:commandButton value="Last opp bilde" action="#{ArticleUpdate_Backing.saveArticle}" />
                               </td>
                               <td><t:outputText binding="#{ArticleUpdate_Backing.upLoadImgResult}"/></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2"><table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                <input name="src" type="text" id="src" value="" class="mceFocus" onchange="ImageDialog.showPreviewImage(this.value);" /></td>
                    ...
                    <fieldset>
                        ...
                        <div id="imgList" style="overflow:auto; height: 180"></div>
                    </fieldset>

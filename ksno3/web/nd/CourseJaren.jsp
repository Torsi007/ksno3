                ...
                <table class="middleSection">
                    <tr>
                        ...
                        <td class="rightSection">
                            <div>
                                <h1>What's a beginners course?</h1>
                                The aim of this course is to provide you with the skills and knowlegde to make you an independant kiter both on water and snow.
                                We teach you the basics, covering safety aspects, site assessment, wind direction, weather behaviour, launching, landing and power control modules. With time allowing we also try to give everyone one-on-one assistance to teach more advanced techniques and skills.
                            </div>
                        </td>
                    </tr>
                </table>
                <table class="bottomSection">
                    <tr>
                        <td>
                            ...
                            <p>Følgende inngår: Overnatting på <a href="http://www.haukeliseter.no/" target="_blank">Haukeliseter fjellstue</a> natt til lørdag og natt til søndag. Felles toalett, dusj og kjøkken i nabobygg. Treretters middag på lørdag, og villmarkspa på kvelden. <br>Tillegg frokost og niste for to dager, kr 330.</p>
                            <p>Kurs og overnatting - full pakke</p>
                            <ul type="square">
                                <li>1 Person : 3295 NOK</li>
                                <li>1 Person, DNT medlem : 3135 NOK</li>
                            </ul>
                            <p>Følgende inngår: Overnatting på <a href="http://www.haukeliseter.no/" target="_blank">Haukeliseter fjellstue</a> natt til lørdag og natt til søndag. Boende i fjellrom med bad og tolett på rommet. Frokost lørdag og søndag, niste og treretters middag på lørdag, og villmarkspa på kvelden.</p>
                            <h2>Teambuilding / Spesialer</h2>
                            ...
                            <h2>Praktisk</h2>
                            <p>Før påmeldingen til et kurs er gyldig må det betales inn 300 NOK i depositum. Depositumet refunderes ikke ved avbestilling. Resten av betalingen gjøres direkte til vår konto før kurset starter eller kontant ved oppmøte. Mer info angående betaling mottas ved påmelding.</p>
                            <h1>Kundegaranti</h1>
